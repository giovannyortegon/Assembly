...
void PrintResult(const char * msg, int a, int b, int c, int d, int e, int f, int g);
...
int main(int argc, char * argv[]) {
	...
	PrintResult("SumSquares - Test Case #1", a, b, c, d, e, f, g);

	a = 10; b = -200; c = 30; d = 40;
	e = -500; f = 60; g = -700;

	sum = SumSquares_(a, b, c, d, e, f, g);
	PrintResult("SumSquares - Test Case #2", a, b, c, d, e, f, g);
