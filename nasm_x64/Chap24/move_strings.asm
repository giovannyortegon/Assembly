...
section .data
	...
	string2 db 0xa, "My string of zeros: "
	string3 db 0xa, "My string of ones: "
	string4 db 0xa, "again My string of ASCII: "
	string5 db 0xa, "copy My string to other string: "
	string6 db 0xa, "reverse copy My string to other: "
