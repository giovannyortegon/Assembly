...
// call an assembly function with int arguments
	printf("Compute area and circumference of a rectangule\n");
	...
	printf("The area of the rectangule = %d\n", r_area);
	printf("The cicumference of the rectangule = %d\n\n", r_circum);
...
// call an assembly function with  double (float) argument
	...
	printf("The circumference of the circule = %lf\n\n", c_circum);
...
// call an assembly function with array argument
	printf("Some array manipulation\n");
