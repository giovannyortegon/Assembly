; An example assembly languages program			SAMPLE.ASM
;
;			Objetive: To demostrate the use of some I/O
;					  routines and to show the structuure
...
ask_count:
	...
	PutInt	CX						; BY DISPLAY ITS VALUE
	PutStr	confirm_msg2
